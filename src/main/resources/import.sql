...
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Rancho da vovó', 15.20, 3)
insert into restaurante (nome, taxa_frete, cozinha_id) values ('Cantinho da pamonha', 5.30, 3)
